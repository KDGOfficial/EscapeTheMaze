Я переработаю `README.md`, чтобы он выглядел более стильно и профессионально, добавлю информацию о том, что проект выполнен студентом второго курса KDG, и сделаю оформление более привлекательным с использованием эмодзи и структурированных разделов. Название проекта оставлю **EscapeTheMaze**, как предложено ранее.
